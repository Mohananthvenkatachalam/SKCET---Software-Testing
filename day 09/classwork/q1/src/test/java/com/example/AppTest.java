...
public class AppTest {
    ...
    public void testHomeLoan() throws InterruptedException {
        ...
        WebElement loan = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div[2]/div[2]/div[2]/a[15]")));
    ...
    public void testHomeLoanCalculator() {
        ...
        try {
            ...
            try {
                WebElement h = wait.until(ExpectedConditions.visibilityOfElementLocated(
